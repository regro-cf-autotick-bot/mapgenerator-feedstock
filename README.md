...
Once the `conda-forge` channel has been enabled, `mapgenerator` can be installed with:

```
conda install mapgenerator
```

It is possible to list all of the versions of `mapgenerator` available on your platform with:
